...
public class ServiceManager : IServiceManager
{
	...
	public ServiceManager(IRepositoryManager repositoryManager, IMapper mapper, UserManager<ApplicationUser> userManager)
	{
		...
		_ApplicationUserService = new Lazy<IApplicationUserService>(() => new ApplicationUserManager(_userManager, mapper));
		_topicService = new Lazy<ITopicService>(() => new TopicManager(repositoryManager,mapper));
	}
